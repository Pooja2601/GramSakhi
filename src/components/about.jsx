  ...
  render() {
    return (
      ...
      <Row>
        ...
        <Col xs={6} md={4}>
        <h2 style={{marginTop:'70px', textAlign:'center'}} id="matabalak">माता बालक उत्कर्ष प्रतिष्ठान प्रेरीत</h2>
        <h3 className="about-text" style={{textAlign:'center'}}>ग्रामसखी</h3>
