    ...
    return (
      ...
      <Row>
        ...
        <img src="img/team/SanjeevniTai.jpg" style={{width:'250px', height:'350px', marginTop:'70px'}}/>
            ...
            <h4 style={{marginBottom:'0', marginTop:'0'}}><b>माता बालक उत्कर्ष प्रतिष्ठान</b></h4>
        </Col>
        <Col xs={6} md={4}>
        <h4 style={{marginTop:'70px', textAlign:'center'}}>माता बालक उत्कर्ष प्रतिष्ठान प्रेरीत</h4>
        <h2 className="about-text section-title" style={{textAlign:'center'}}>ग्रामसखी</h2>
        ...
        <img src="img/team/sujata.jpg" style={{width:'250px', height:'350px', marginTop:'70px'}}/> 
            ...
            <h4 style={{marginBottom:'0', marginTop:'0'}}><b>ग्रामसखी फुडस्</b></h4>
        </Col>
      </Row>
    </Container>
    )
